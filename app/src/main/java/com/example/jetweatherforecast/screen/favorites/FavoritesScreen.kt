package com.example.jetweatherforecast.screen.favorites
...
fun FavoritesScreen(navController: NavController,
    ...
    Scaffold(topBar = {
        ...
        Surface(modifier = Modifier
            .padding(top = it.calculateTopPadding(), bottom = 5.dp, start = 5.dp, end = 5.dp)
            .fillMaxWidth()
        ) {
            Column(
    ...
    Surface(modifier = Modifier
        ...
        .clickable {
                   navController.navigate(
                       WeatherScreens.MainScreen.name + "/${favorite.cityName}")
        },
